...
#if ANY(HAS_DGUS_LCD, MALYAN_LCD, TOUCH_UI_FTDI_EVE, ANYCUBIC_LCD_I3MEGA, ANYCUBIC_LCD_CHIRON, EXTUI_TESTLVGL)
  #define IS_EXTUI 1
...
// FSMC/SPI TFT Panels using standard HAL/tft/tft_(fsmc|spi).h
  ...
  #endif
#elif ENABLED(SDL_DISPLAY)
  #define HAS_SDL_TFT 1
#endif

#if ENABLED(EXTUI_TESTLVGL) && ANY(HAS_FSMC_TFT,HAS_SPI_TFT,HAS_SDL_TFT)
    #define HAS_LVGL
#endif

#if BOTH(HAS_LVGL,HAS_SDL_TFT)
  #define HAS_LVGL_DRIVERS
#endif
